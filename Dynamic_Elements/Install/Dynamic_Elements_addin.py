...
class SVA_BoxSizing_Btn(object):
    """Implementation for Dynamic_Elements_addin.svaButton (Button)"""
    def __init__(self):
        self.enabled = True
        self.checked = False
    def onClick(self):
...
class SVA_Box_Sizing(object):
    """Implementation for Dynamic_Elements_addin.DynElem_Ext (Extension)"""
    def __init__(self):
