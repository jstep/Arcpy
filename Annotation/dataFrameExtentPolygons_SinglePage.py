...
poly_filename = "DF_Polygons_{}_{}".format(orient, pageName)
...
# Create FGDB.
for df in onMapDFs:
    arcpy.CreateFileGDB_management(workspace, "{}_{}_{}".format(pageName, df.name, str(df.scale)), "CURRENT")

del coords, feature_info, features, feature, poly_filename, outDir, mxd, df_lst, df_info, df, XMax, XMin, YMax, YMin, orient, ddp, pageName 
